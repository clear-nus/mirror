...
class BehaviorAgentRandomTraffic(Agent):
    """
    ...
    def __init__(self, vehicle, ignore_traffic_light=False, behavior='normal'):
        ...
        super(BehaviorAgentRandomTraffic, self).__init__(vehicle)
    ...
    def _overtake(self, location, waypoint, vehicle_list, distance):
        """
    ...
    def collision_and_car_avoid_manager(self, location, waypoint):
        ...
        if self.direction == RoadOption.CHANGELANELEFT:
            ...
            if vehicle_state:
                self._overtake(location, waypoint, vehicle_list, distance)
